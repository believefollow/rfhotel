...
pub type ManagersSchema = Schema<QueryRoot, EmptyMutation, EmptySubscription>;

pub struct ManagersChar {
    id: &'static str,
    name: &'static str,
    friends: Vec<usize>,
...
impl Managers {
    ...
    pub fn new() -> Self {
        ...
        let luke = chars.insert(ManagersChar {
            id: "1000",
            name: "Luke Skywalker",
            friends: vec![],
            appears_in: vec![],
        ...
        let vader = chars.insert(ManagersChar {
            id: "1001",
        ...
        let han = chars.insert(ManagersChar {
            id: "1002",
            name: "Han Solo",
            friends: vec![],
        ...
        let leia = chars.insert(ManagersChar {
            id: "1003",
            name: "Leia Organa",
            friends: vec![],
            appears_in: vec![Gender::Male],
        ...
        let tarkin = chars.insert(ManagersChar {
            id: "1004",
            name: "Wilhuff Tarkin",
            friends: vec![],
        ...
        let threepio = chars.insert(ManagersChar {
            id: "2000",
            name: "C-3PO",
            friends: vec![],
        ...
        let artoo = chars.insert(ManagersChar {
            id: "2001",
            name: "R2-D2",
            friends: vec![],
            appears_in: vec![Gender::Female],
